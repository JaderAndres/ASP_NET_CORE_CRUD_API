...
namespace PracticaDTOFluentVaidation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ConduccionDbContext>(
                options => options.UseSqlServer("name=ConnectionStrings:Conexion"));

            //services.AddDbContext<ConduccionDbContext>(options =>
            //    options.UseSqlServer(Configuration.GetConnectionString("ConnectionText")));
